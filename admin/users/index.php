...
<div class="container">
    <div class="row">
        ...
        <div class="posts col-10">
            ...
            <?php foreach ($UserTabl as $key => $rams):?>
            <div class="row post">
                <div class="id col-1"><?= $key + 1; ?></div>
                <div class="title col-2"><?=$rams['username']?></div>
                <div class="marka col-2"><?php if ($rams['admin']): ?>Админ<?php else:?>Пользователь<?php endif;?></div>
                <div class="marka col-3"><?= $rams['email']; ?></div>
                <div class="red col-2"><a href="edit.php?id=<?= $rams['id'];?>">Изменить</a></div>
                <div class="del col-1"><a href="edit.php?del=<?= $rams['id']; ?>">Удалить</a></div>
            </div>
            <?php endforeach;?>
        </div>
    </div>
