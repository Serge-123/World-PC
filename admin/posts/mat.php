    ...
    <div class="row">
        ...
        <div class="posts col-10">
            <div class="row title-table">
                <a href="<?php echo BASE_URL . "admin/posts/create.php?". $smen = "5";?>" class="col-2 btn  btn-success">Добавить</a>
                <span class="col-1"></span>
                <a href="<?php echo BASE_URL . "admin/posts/ram.php";?>" class="col-3  btn btn-warning">Управлять</a>
            </div>
            <div class="row title-table">

                <h2>Управление материнская плата</h2>
            ...
            <?php foreach ($mat as $key => $rams):?>
                <div class="row post">
                    ...
                    <div class="red col-2"><a href="edit.php?id_mat=<?= $rams['id'];?>">Изменить</a></div>
                    <div class="del col-1"><a href="edit.php?del_mat=<?= $rams['id']; ?>">Удалить</a></div>
                </div>
            <?php endforeach;?>
        </div>
    </div>
