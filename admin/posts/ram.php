       ...
       <?php include "../../app/include/sidebar-admin.php" ?>
        ...
        <div class="posts col-10">
            <div class="row title-table">
                <a href="<?php echo BASE_URL . "admin/posts/create.php?". $smen = "1";?>" class="col-2 btn  btn-success">Добавить</a>
                <span class="col-1"></span>
                <a href="<?php echo BASE_URL . "admin/posts/ram.php";?>" class="col-3  btn btn-warning">Управлять</a>
            </div>
            <div class="row title-table">

                <h2>Управление RAM</h2>
            ...
            <div class="row post">
                ...
                <div class="red col-2"><a href="edit.php?id_ram=<?= $rams['id'];?>">Изменить</a></div>
                <div class="del col-1"><a href="edit.php?del_ram=<?= $rams['id']; ?>">Удалить</a></div>
            </div>
            <?php endforeach;?>
        </div>
    </div>
