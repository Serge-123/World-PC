...
$ram =selectAll('pitanie');
$Karusel = selectAllFromKaruselWithUsers('pitanie');
?>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-item">
                    <?php endif;?>
                    <img src="<?=BASE_URL . 'assets/images/pit/' . $kar['img']?>" class="d-block w-100 first" alt="...">
                    <div class="carousel-caption-hack carousel-caption d-none d-md-block">
                        <h5><a href="<?php echo BASE_URL . "single.php?id_pit=" . $kar['id']?>"><?=$kar['name']?></a></h5>
                    </div>
                </div>
                ...
                <?php foreach ($ram as $rams):?>
                    <div class="post row">
                        ...
                        <div class="post_text col-12 col-md-8">
                            <h4>
                                <a href="<?php echo BASE_URL . "single.php?id_pit=".$rams['id'];?>"><?= $rams['name']?></a>
                            </h4>
            ...
            <div class="sidebar col-md-3 col-12">
                ...
                <div class="section search">
                    ...
                    <form action="search.php" method="post">
                        <input type="text" name="search-pit" class="text-input" placeholder="Введите искомый товар...">
                    </form>
                </div>
