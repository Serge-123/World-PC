...
//$limit = 2;
//$offset = ($page - 1) * $limit;
//$total_pages = round(countRow('ram') / $limit, 0);

$ram =selectAll('ram');
$Karusel = selectAllFromKaruselWithUsers('ram');
            ...
            <?php foreach ($Karusel as $key => $kar):?>
                ...
                <?php else:?>
                    <div class="carousel-item">
                        <?php endif;?>
                    <img src="<?=BASE_URL . 'assets/images/mram/' . $kar['img']?>" class="d-block w-100 first" alt="...">
                    <div class="carousel-caption-hack carousel-caption d-none d-md-block">
                    <h5><a href="<?php echo BASE_URL . "single.php?id_ram=" . $kar['id']?>"><?=$kar['name']?></a></h5>
                </div>
            </div>
    ...
    <div class="content row">
            ...
            <?php foreach ($ram as $rams):?>
                <div class="post row">
                    ...
                    <div class="post_text col-12 col-md-8">
                        <h4>
                            <a href="<?php echo BASE_URL . "single.php?id_ram=".$rams['id'];?>"><?= $rams['name']?></a>
                        </h4>
        ...
        <div class="sidebar col-md-3 col-12">
            ...
            <form action="search.php" method="post">
                <input type="text" name="search-ram" class="text-input" placeholder="Введите искомый товар...">
            </form>
        </div>
